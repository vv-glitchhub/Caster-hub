...
export default function StockcasterWealthPage() {
  return (
    <main className="min-h-screen overflow-hidden bg-[#030712] px-6 py-28 text-white">
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_78%_12%,rgba(234,179,8,0.24),transparent_32%),radial-gradient(circle_at_18%_82%,rgba(59,130,246,0.24),transparent_30%),linear-gradient(180deg,#030712,#08111f_55%,#020207)]" />
      <div className="grid-overlay" />

      <div className="relative z-10 mx-auto max-w-7xl">
        <a href="/dashboard" className="text-xs uppercase tracking-[0.28em] text-white/45 hover:text-white">← Dashboard</a>
        <p className="mt-16 section-label">Wealth / Stockcaster</p>
        ...
        <p className="mt-8 max-w-3xl text-xl leading-8 text-white/62">
          Stockcaster becomes the Wealth layer of Caster OS: portfolio intelligence, market signals, risk control and future planning.
        </p>
        ...
        <section className="mt-14 grid gap-6 lg:grid-cols-[1fr_0.9fr]">
          <div className="dashboard-preview min-h-0">
            ...
            <h2 className="mt-5 text-5xl font-semibold tracking-tight">€24,800</h2>
            <p className="mt-3 text-white/50">Prototype net worth display</p>
            <div className="mt-8 grid gap-3 md:grid-cols-3">
              <div className="preview-row">Cash · 32%</div>
              <div className="preview-row">Funds · 48%</div>
              <div className="preview-row">Stocks · 20%</div>
            </div>
          </div>

          <div className="dashboard-preview min-h-0">
            <p className="text-xs uppercase tracking-[0.35em] text-yellow-200/70">AI Market Desk</p>
